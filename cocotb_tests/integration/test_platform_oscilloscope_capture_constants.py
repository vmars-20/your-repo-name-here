"""
Test Constants for Platform Oscilloscope Capture Tests

Shared constants for progressive testing of oscilloscope signal capture
with hierarchical voltage encoding.
"""

from pathlib import Path

MODULE_NAME = "platform_oscilloscope_capture"
...
class TestValues:
    ...
    P1_CAPTURE_DURATION_NS = 200     # 200ns capture (25 samples @ 125MHz)
    P1_DECODE_DURATION_NS = 1000     # 1us capture for state progression
    P1_FAULT_DURATION_NS = 1000      # 1us capture for fault detection (overflow is pulsed!)
    MIN_SAMPLES = 10                 # Minimum samples for valid capture
...
class ErrorMessages:
    ...
    NO_FAULT_DETECTED = "No negative voltage samples (fault flag not detected)"
